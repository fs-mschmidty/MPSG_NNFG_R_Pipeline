build_eligible_list <- function(state_lists, occ_lists, ne_state_list, sd_state_list){
  ...
  ns_state_eligible_cl<-ns_state_eligible |>
    select(taxon_id, scientific_name, common_name, rounded_gRank, NE_sRank, SD_sRank, usfws_status = u_s_endangered_species_act_status, sd_te, nebraska_swap, kingdom:form) |>
