...
if (m_source == "BIEN" | m_source == "IUCN") {
  ...
  p_base +
    ...
    geom_sf_label(data = aoa, label = "Nebraska National\nForest and Grasslands", size = 3, nudge_x = 200000, nudge_y = 200000) +
...
if (m_source == "EBIRD" | is.na(m_source)) {
  ...
  if (is.na(m_source)) {
    ...
    p_base_a <- p_base +
      ...
      geom_sf(data = aoa, fill = "yellow", color = "transparent") +
      geom_sf_label(data = aoa, label = "Nebraska National\nForest and Grasslands", size = 2.5, nudge_x = 200000, nudge_y = 200000) +
...
p_base +
  ...
  geom_sf(data = sp_polys, fill = "#7d3c98") +
...
HABITAT NARRAITVE FROM NATURESERVE: `r comment_narrative`
