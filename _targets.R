...
list(
  ...
  tar_target(fwfish1_iucn_map_list, build_iucn_available_maps(file.path(external_data_folder, "IUCN", "FW_FISH_PART1.shp"), eligible_lists, nnfg_bd)),
  tar_target(fwfish2_iucn_map_list, build_iucn_available_maps(file.path(external_data_folder, "IUCN", "FW_FISH_PART2.shp"), eligible_lists, nnfg_bd)),
  tar_target(molluscs_iucn_map_list, build_iucn_available_maps(file.path(external_data_folder, "IUCN", "FW_MOLLUSCS.shp"), eligible_lists, nnfg_bd)),
  tar_target(odonata_iucn_map_list, build_iucn_available_maps(file.path(external_data_folder, "IUCN", "FW_ODONATA.shp"), eligible_lists, nnfg_bd)),
  tar_target(crayfish_iucn_map_list, build_iucn_available_maps(file.path(external_data_folder, "IUCN", "FW_CRAYFISH.shp"), eligible_lists, nnfg_bd)),
  tar_target(all_iucn_map, build_all_iucn_map(
    mammal_iucn_map_list,
    amphibian2_iucn_map_list,
    amphibian1_iucn_map_list,
